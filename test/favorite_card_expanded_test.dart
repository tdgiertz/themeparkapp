...
void main() {
  ...
  testWidgets('ExpandedFavoriteCard renders ride open status and mobile swipe hints', (tester) async {
  ...
  testWidgets('ExpandedFavoriteCard renders dining entity with View Menu micro-action', (tester) async {
    final favorite = FavoriteRide(
  ...
  testWidgets('ExpandedFavoriteCard renders desktop buttons instead of swipe instructions', (tester) async {
    final favorite = FavoriteRide(
  ...
  testWidgets('ExpandedFavoriteCard renders offline closed state contrast container', (tester) async {
    final favorite = FavoriteRide(
      rideId: 'hagrid',
    ...
    expect(find.text('Temporarily closed for maintenance. Check back soon.'), findsOneWidget);
  });
}
