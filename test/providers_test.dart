...
void main() {
  ...
  test('waitTimesProvider family returns wait times and merges partial updates on refresh', () async {
    Future<String> loader(String path) async => File(path).readAsString();
    final container = ProviderContainer(
      overrides: [assetLoaderProvider.overrideWithValue(loader)],
    );
    ...
    final initialA1 = initialResponse.waitTimes.firstWhere((e) => e.rideId == 'a1');
    ...
    final updatedA1 = updatedResponse.waitTimes.firstWhere((e) => e.rideId == 'a1');
    expect(updatedA1.waitMinutes, equals(75));

    // Verify ride a3 is closed (waitMinutes is null)
    final updatedA3 = updatedResponse.waitTimes.firstWhere((e) => e.rideId == 'a3');
    ...
    final updatedA2 = updatedResponse.waitTimes.firstWhere((e) => e.rideId == 'a2');
