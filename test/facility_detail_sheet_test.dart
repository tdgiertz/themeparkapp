...
void main() {
  group('FacilityDetailSheetContent Widget Tests', () {
    ...
    testWidgets('Renders ride facility details, wait time, height requirement, and area chart', (tester) async {
    ...
    testWidgets('Renders closed state for ride facility when wait is closed or null', (tester) async {
      await tester.pumpWidget(
        buildTestSheet(
          facility: mockRideFacility,
          wait: mockClosedWait,
    ...
    testWidgets('Tapping Join Virtual Queue changes state to joining then joined', (tester) async {
      await tester.pumpWidget(
        buildTestSheet(
          facility: mockRideFacility,
          wait: mockOpenWait,
    ...
    testWidgets('Renders dining facility, menu categories, items, and handles dietary filter toggling', (tester) async {
      await tester.pumpWidget(
        buildTestSheet(
          facility: mockDiningFacility,
        ),
      );
