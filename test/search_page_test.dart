...
void main() {
  ...
  group('SearchPage Responsive Layout Tests', () {
    testWidgets('SearchPage renders mobile layout elements correctly', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            userLocationProvider('p2').overrideWith(MockUserLocationNotifier.new),
          ],
      ...
      expect(find.byKey(const ValueKey('search_textfield_mobile')), findsOneWidget);
      // Verify initial welcome message text in bubble
      expect(find.textContaining('Welcome! I am your AI travel agent assistant.'), findsOneWidget);
    ...
    testWidgets('SearchPage renders 3-pane desktop layout correctly', (WidgetTester tester) async {
      ...
      expect(find.byKey(const ValueKey('search_textfield_desktop')), findsOneWidget);
  ...
  group('SearchPage User Gestures & State Updates', () {
    testWidgets('Submitting text query via send button adds user and agent messages', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(400, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
        tester.view.resetPhysicalSize();
    ...
    testWidgets('Tapping voice input mic button displays voice dictation overlay and cancel button', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(400, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
        tester.view.resetPhysicalSize();
    ...
    testWidgets('Selecting facility on Desktop populates Pane 2 with restaurant menu and dietary chips', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
        tester.view.resetPhysicalSize();
    ...
    testWidgets('AppBar clear button resets conversation state', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(400, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
        tester.view.resetPhysicalSize();
